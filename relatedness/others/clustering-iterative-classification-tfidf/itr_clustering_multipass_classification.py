...
iterations=10
maxTrainRatio =0.9
trainFile = "/home/owner/PhD/dr.norbert/dataset/shorttext/data-web-snippets/semisupervised/websnippetraw_ensembele_train"
testFile = "/home/owner/PhD/dr.norbert/dataset/shorttext/data-web-snippets/semisupervised/websnippetraw_ensembele_test"
traintestFile = "/home/owner/PhD/dr.norbert/dataset/shorttext/data-web-snippets/semisupervised/websnippetraw_ensembele_traintest"
...
extClustFile = "/home/owner/PhD/dr.norbert/dataset/shorttext/data-web-snippets/2n-websnippet-glove-sparse-2280-0-labels" 
...
def Gen_WriteOutliersEachGroup(labelDir, numberOfClusters):
 ...
 for labelID in range(numberOfClusters):
  ...
  dic_label_outliers[str(fileId)] = outlierPreds 
...
def ComputePurity(dic_tupple_class):
 ...
 print("purity majority="+str(purity))
 return purity
