...
terms = set(terms)
#gloveFile = "/users/grad/rakib/dr.norbert/dataset/shorttext/glove.42B.300d/glove.42B.300d.txt"
...
file=open("/users/grad/rakib/dr.norbert/dataset/shorttext/agnews/semisupervised/agnewsraw_ensembele_traintest","w")
