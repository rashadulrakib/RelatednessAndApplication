	...
	public List<double[][]> SparsifyDocDisSimilarityMatrixAlgorithomicExactIterative(
		...
		try{
			...
			while(!isGoodAvg){
				...
				UtilsShared.WriteMatrixToFile("/users/grad/rakib/dr.norbert/dataset/shorttext/biomedical/2n-biomedical-w2vec-bioasq-sparse-20000-"+whileCount, sparsifyDistMatrix, " ");
