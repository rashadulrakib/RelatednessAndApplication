...
public class TokenizeTrigramFromTokenizedByEliasOmega {

	EliasOmega.EliasOmegaEncoder objEncodeOmega;
	
	public void TokenizeTrigramEliasOmega(){
		try{
			...
			for(char ch='x'; ch<='z';ch++){
				...
				String outfilePath = PhraseDirectories.tokenizedTriGramEliasOmegaDir+String.valueOf(ch);
			...
			System.out.println("TokenizeTrigramFromTokenizedByEliasOmega finished.");
		}catch(Exception e){
			e.printStackTrace();
		}
	}
